...
export default function HomePage() {
  return (
    <>
      <div className='mt-24 bg-white p-4 container ml-40 rounded-lg' >
        <div className='mt-2 p-3'>
          <h4 className='mb-2 tracking-widest text-gray-800 md:text-lg dark:text-gray-400 flex items-center justify-center md:justify-start'>
            <svg
      ...
      <div className='mt-4 bg-white p-4 container ml-40 mb-5 rounded-lg' >
